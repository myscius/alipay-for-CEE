...
Page({
  ...
  async search(e) {
    ...
    context.callFunction({
      name: 'province_line',
      data: {
        pro_province: that.data.province,
        //省份
        pro_prosel: that.data.type_num,
        //文理科
      ...
      success: function (res) {
        ...
        if (line_list != 0) {
          ...
          that.setData({
            [grade_2015]: line_list[0]["graa"],
            [grade_2016]: line_list[0]["grab"],
            [grade_2017]: line_list[0]["grac"]
          });
          that.line_ctx();
          ...
          my.showToast({
            content: "无" + that.data.province + "数据，请等待跳转",
            type: "loading",
            mask: true,
            complete: function (e) {
              setTimeout(function () {
